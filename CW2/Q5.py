...
for epoch in range(train_epoch):
    ...
    for x_, y_ in train_loader:
        ...
        G_class_output = classifer(G_result)
        G_class_output = torch.exp(G_class_output)
        
        G_entropy = (G_class_output * torch.log(G_class_output))
        G_entropy_loss = torch.t(G_entropy).sum()
        
        G_train_loss = G_train_loss - G_entropy_loss

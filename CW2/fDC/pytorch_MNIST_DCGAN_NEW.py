...
if not os.path.isdir('MNIST_DCGAN_results/Losses'): # ADDED
    os.mkdir('MNIST_DCGAN_results/Losses')
...
np.savetxt('MNIST_DCGAN_results/Losses/GLoss.txt',epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
np.savetxt('MNIST_DCGAN_results/Losses/DLoss.txt',epoch_D_losses,delimiter='\n')

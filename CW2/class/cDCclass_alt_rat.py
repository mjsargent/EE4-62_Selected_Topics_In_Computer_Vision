...
balance_ratios = [1,2,5]
for rat in balance_ratios:
  # network
    G = generator(64)
    D = discriminator(64)
    ...
    os.makedirs('MNIST_cDCGAN_results/altrat{}_results'.format(rat), exist_ok=True)
    np.savetxt('MNIST_cDCGAN_results/altrat{}_results/GLoss.txt'.format(rat),epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
    np.savetxt('MNIST_cDCGAN_results/altrat{}_results/DLoss.txt'.format(rat),epoch_D_losses,delimiter='\n')
    ...
    np.savetxt('MNIST_cDCGAN_results/altrat{}_results/performance.txt'.format(rat),[total_store])
    np.savetxt('MNIST_cDCGAN_results/altrat{}_results/mean_inc.txt'.format(rat),mean_inception_store)
    np.savetxt('MNIST_cDCGAN_results/altrat{}_results/std_inc.txt'.format(rat),std_inception_store)

...
for lrG in G_lrates:
    for lrD in D_lrates:
        ...
        os.makedirs('MNIST_cDCGAN_results/lrG{}_lrD{}_results'.format(lrG,lrD), exist_ok=True)
        np.savetxt('MNIST_cDCGAN_results/lrG{}_lrD{}_results/GLoss_lrG{}_lrD{}.txt'.format(lrG,lrD,lrG,lrD),epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
        np.savetxt('MNIST_cDCGAN_results/lrG{}_lrD{}_results/DLoss_lrG{}_lrD{}.txt'.format(lrG,lrD,lrG, lrD),epoch_D_losses,delimiter='\n')
        ...
        np.savetxt('MNIST_cDCGAN_results/lrG{}_lrD{}_results/performance_lrG{}_lrD{}.txt'.format(lrG,lrD,lrG,lrD),[total_store])
        np.savetxt('MNIST_cDCGAN_results/lrG{}_lrD{}_results/mean_inc_lrG{}_lrD{}.txt'.format(lrG,lrD,lrG,lrD),mean_inception_store)
        np.savetxt('MNIST_cDCGAN_results/lrG{}_lrD{}_results/std_inc_lrG{}_lrD{}.txt'.format(lrG,lrD,lrG,lrD),std_inception_store)

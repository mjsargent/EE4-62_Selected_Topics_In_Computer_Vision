...
for rat in balance_ratios:
    ...
    os.makedirs('MNIST_cDCGAN_results/rat{}_results'.format(rat), exist_ok=True)
    np.savetxt('MNIST_cDCGAN_results/rat{}_results/GLoss.txt'.format(rat),epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
    np.savetxt('MNIST_cDCGAN_results/rat{}_results/DLoss.txt'.format(rat),epoch_D_losses,delimiter='\n')
    ...
    np.savetxt('MNIST_cDCGAN_results/rat{}_results/performance.txt'.format(rat),[total_store])
    np.savetxt('MNIST_cDCGAN_results/rat{}_results/mean_inc.txt'.format(rat),mean_inception_store)
    np.savetxt('MNIST_cDCGAN_results/rat{}_results/std_inc.txt'.format(rat),std_inception_store)

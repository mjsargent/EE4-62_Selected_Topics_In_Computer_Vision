...
for epoch in range(train_epoch):
    ...
    fixed_p = root + 'Fixed_results/' + model + 'Lsmooth_' + str(epoch + 1) + '.png'
...
np.savetxt('MNIST_cDCGAN_results/Losses/GLoss_Lsmooth.txt',epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
np.savetxt('MNIST_cDCGAN_results/Losses/DLoss_Lsmooth.txt',epoch_D_losses,delimiter='\n')

...
for G_lr in G_lrates:
    for D_lr in D_lrates:
        ...
        for epoch in range(train_epoch):
            ...
            fixed_p = root + 'Fixed_results/' + model + 'Glr_' + str(G_lr) + '_Dlr_' + str(D_lr) + '_' + str(epoch + 1) + '.png'
        ...
        np.savetxt('MNIST_cDCGAN_results/Losses/GLoss_Glr_' + str(G_lr) + '_Dlr' + str(D_lr) + '.txt',epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
        np.savetxt('MNIST_cDCGAN_results/Losses/DLoss_Glr_' + str(G_lr) + '_Dlr' + str(D_lr) + '.txt',epoch_D_losses,delimiter='\n')

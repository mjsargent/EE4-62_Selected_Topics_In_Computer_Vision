...
for rat in balance_ratios:
    ...
    for epoch in range(train_epoch):
        ...
        fixed_p = root + 'Fixed_results/' + model + 'rat_' + str(rat) + '_' + str(epoch + 1) + '.png'
    ...
    np.savetxt('MNIST_cDCGAN_results/Losses/GLoss_rat_' + str(rat) + '.txt',epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
    np.savetxt('MNIST_cDCGAN_results/Losses/DLoss_rat_' + str(rat) + '.txt',epoch_D_losses,delimiter='\n')

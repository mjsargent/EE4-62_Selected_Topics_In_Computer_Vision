...
no_kernels = [32,64,128]

for n_k in no_kernels:
    ...
    for epoch in range(train_epoch):
        ...
        fixed_p = root + 'Fixed_results/' + model + 'nk_' + str(n_k) + '_' str(epoch + 1) + '.png'
    ...
    np.savetxt('MNIST_cDCGAN_results/Losses/GLoss_nk_' + str(n_k) + '.txt',epoch_G_losses,delimiter='\n') # SAVE THESE RESULTS WHERE?
    np.savetxt('MNIST_cDCGAN_results/Losses/DLoss_nk_' + str(n_k) + '.txt',epoch_D_losses,delimiter='\n')

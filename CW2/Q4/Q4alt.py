...
for synth_proportion in [1,5,10,15,20]:#[0.1,0.2,0.5,1.0]:
    ...
    for syn_epoch in range(synth_proportion):
        for n in range(468):
    ...
    os.makedirs('Q4alt/sProp{}'.format(synth_proportion), exist_ok=True)
    np.savetxt('Q4alt/sProp{}/Acc.txt'.format(synth_proportion), [acc],delimiter='\n')
